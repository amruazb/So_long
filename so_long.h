...
void			add_images(t_game *mlx, t_map *map_array, t_dimensions dimensions);
...
//int				key_controls(int keycode, t_map *map_array);
...
// void graphical_interface(t_map *map_array, t_dimensions dimensions)
// {
//     void *mlx;
//     void *win;
//     void *background_img;
